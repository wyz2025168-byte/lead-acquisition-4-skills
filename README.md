...
> 唯一正式安装入口。以真实价值交换为目标，贯通定位、内容、拍摄、内容配比与发布运营；已完成确定性门禁和独立自然盲评，现作为现场验证版发布。
...
本版本已通过19项确定性测试、10项脱敏回放和21次独立自然运行盲评（6/7场景稳定通过、硬失败0）。真实获客与成交效果仍需现场验证；不保证流量、咨询或成交。旧项目升级见 [UPGRADE](docs/UPGRADE.md)，真实测试见 [FIELD_TESTING](docs/FIELD_TESTING.md)。
