---
name: jw
description: 线索获客4.0 v4.0.0-rc.1 业务推理与项目控制系统。用于从零初始化或接管真实获客项目，从真实正价或等价价值交换倒推产品、人群、交易角色、线上可转化、W1–W6、人物选择、内容、拍摄、组合和运营；同时管理证据范围、替代方案、审批原话、状态恢复和局部失效。用户要求使用 $jw 推进获客、判断定位/人群/购买理由、制作内容与拍摄运营方案、恢复旧项目、运行 doctor/capabilities 或导出反馈时使用。
---
